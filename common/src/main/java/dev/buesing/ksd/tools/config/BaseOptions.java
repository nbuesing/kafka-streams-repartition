...
public abstract class BaseOptions {
    ...
    @Parameter(names = { "--quantity-purchased-topic" }, description = "")
    private String quantityPurchasedTopic = "quantity-purchased";
...
//    private String postalRepartition = "pickup-order-analyticsuser-postal-summary-groupByPostalCode-repartition";
    ...
    @Parameter(names = { "--product-purchased-restore" }, description = "")
    private String productPurchasedRestore = "product-purchased-restore";
