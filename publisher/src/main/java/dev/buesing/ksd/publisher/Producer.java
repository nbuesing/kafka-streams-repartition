...
public class Producer {
    ...
    public void start() {
        ...
        while (true) {
            ...
            kafkaProducer.send(new ProducerRecord<>(options.getPurchaseTopic() + "-" + options.getVersion(), null, purchaseOrder.getOrderId(), purchaseOrder), (metadata, exception) -> {
                if (exception != null) {
    ...
    private Map<String, Object> properties(final Options options) {
        return Map.ofEntries(
                ...
                Map.entry(ProducerConfig.TRANSACTIONAL_ID_CONFIG, UUID.randomUUID().toString()),
